...
export const metadata: Metadata = {
  ...
  description: "Experience unparalleled luxury at Grand Vista Hotel. Premium suites, world-class amenities, fine dining, and exceptional service in the heart of the city.",
  keywords: "luxury hotel, premium accommodations, five star hotel, spa, fine dining, executive suites",
  ...
  openGraph: {
    title: "Grand Vista Hotel - Luxury Accommodations & World-Class Service",
    description: "Experience unparalleled luxury at Grand Vista Hotel. Premium suites, world-class amenities, fine dining, and exceptional service.",
    url: "https://grandvistahotel.com",
    siteName: "Grand Vista Hotel",
    images: [
      {
        url: "https://images.pexels.com/photos/1755288/pexels-photo-1755288.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Grand Vista Hotel elegant exterior entrance"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Grand Vista Hotel - Luxury Accommodations & World-Class Service",
    description: "Experience unparalleled luxury at Grand Vista Hotel. Premium suites, world-class amenities, fine dining, and exceptional service.",
    images: ["https://images.pexels.com/photos/1755288/pexels-photo-1755288.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
